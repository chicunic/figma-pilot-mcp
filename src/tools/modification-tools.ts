...
const tools: ToolDef[] = [
  ...
  // ==================== Layout ====================
  {
    ...
    schema: z.object({
      ...
      primaryAxisAlignItems: z.enum(["MIN", "CENTER", "MAX", "SPACE_BETWEEN"]).default("MIN").describe("Main axis alignment"),
      counterAxisAlignItems: z.enum(["MIN", "CENTER", "MAX", "BASELINE"]).default("MIN").describe("Cross axis alignment"),
    ...
    schema: z.object({
      ...
      settings: z.array(z.object({
        ...
        constraint: z.object({
          ...
          value: z.number(),
        }).optional().describe("Size constraint"),
